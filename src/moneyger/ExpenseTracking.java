...
public class ExpenseTracking extends javax.swing.JPanel {
     ...
     */
    public ExpenseTracking(Moneyger mainFrame) {
        initComponents();
    ...
    private void initComponents() {
        ...
        CategoryDropdown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"Food & Drinks", "Transportation", "Shopping", "Vehicle", "Life & Entertainment", "Gadgets"}));
        ...
        ExpenseLoggerTitles.setIcon(new javax.swing.ImageIcon(getClass().getResource("/moneyger/UI Elements/ExpenseTracking/Group 16ET.png"))); // NOI18N
        ...
        ExpenseTrackingButton.setBounds(100, 340, 160, 40);
        ...
        SideMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/moneyger/UI Elements/New BG/Group 36.png"))); // NOI18N
        add(SideMenu);
        SideMenu.setBounds(80, 70, 210, 541);

        WhiteBG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/moneyger/UI Elements/ExpenseTracking/whitebg.png"))); // NOI18N
        add(WhiteBG);
        WhiteBG.setBounds(45, 40, 983, 614);

        BaseBG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/moneyger/UI Elements/ExpenseTracking/Rectangle.png"))); // NOI18N
        add(BaseBG);
...
public class DatabaseConnection {
    ...
    try (Connection conn = ExpenseTracking.DatabaseConnection.getConnection()) {
        ...
        String insertSql = "INSERT INTO expenses (account_column, category_column, value_column, note_column) VALUES (?, ?, ?, ?)";
        ...
        if (rowsAffected > 0) {
            ...
            String selectSql = "SELECT account_column, category_column, value_column, note_column, created_at FROM expenses";
